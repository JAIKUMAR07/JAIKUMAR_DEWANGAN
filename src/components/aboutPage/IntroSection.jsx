        ...
        <div className="px-4 mx-auto w-full max-w-screen-xl grid lg:grid-cols-2 gap-4 lg:gap-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mb-4 md:mb-8 text-base md:text-lg font-normal text-gray-700 dark:text-gray-400">
              ...
              solid foundation in C++, data structures, and algorithms. <br className="hidden md:block" />
              ...
              <br className="hidden md:block" />I enjoy transforming ideas into functional solutions and am
              eager to apply my technical skills to real-world challenges. I'm
              driven to contribute to innovative and impactful projects.
            </p>
            <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0">
              <button className="px-5 md:px-7 py-2 mt-2 bg-primary text-center items-center font-semibold rounded-lg border-none transition-all duration-300 ease-in-out transform active:scale-95 bg-amber-300 hover:shadow-lg hover:shadow-cyan-500 focus:outline-none hover:scale-110">
